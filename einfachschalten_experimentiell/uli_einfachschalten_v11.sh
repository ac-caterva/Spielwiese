...
_LOGFILE_=/var/log/uli_einfachschalten_${_DATUM_}.txt
...
echo "Bei jedem Start wird ein Logfile unter /var/log/uli_einfachschalten_YYYY-mm-dd_HH-MM.txt angelegt mit Start Datum/Uhrzeit." | tee -a ${_LOGFILE_}
